...
$html = '
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>Items Report. Report Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            <thead>
                <tr>
                    ...
                    <th style="width:100%">Retail Price</th>
            ...
            '
                    <tr>
                        ...
                        <td>' . "Ksh " . number_format($sales->product_purchase_price, 2) . '</td>
                        <td>' . "Ksh " . number_format($sales->product_sale_price, 2) . '</td>
                        <td>' . "Ksh " . number_format(($sales->product_sale_price-$sales->product_purchase_price), 2) . '</td>
                    </tr>
                    ';
            }
            $html .= '
...
$dompdf->render();
$dompdf->stream('Items Report', array("Attachment" => 1));
