                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="top_manager_dashboard.php"> <i class="fa fa-home"></i> </a>
                                            </li>
                                            <li class="breadcrumb-item">
                                                <a href=""> Reports </a>
                                            </li>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="text-center">
                                                        <a class="btn btn-primary" href="main_dashboard_system_sales_pdf_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                                        <a class="btn btn-primary" href="main_dashboard_system_sales_xls_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-spreadsheet"></i> Export To Excel</a>
                                                    </div>
                                                    <br>
                                                    <div class="card">
                                                            ...
                                                            <table class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($sales = $res->fetch_object()) {
                                                                        /* Sale Amount  */
                                                                        $sales_amount = $sales->sale_quantity * ($sales->product_sale_price - $sales->sale_discount);
                                                                    ?>
                                                                        <tr>
                                                                    ...
                                                                    ?>
                                                                    <tr>
                                                                        <td colspan="4">Cumulative Income:</td>
