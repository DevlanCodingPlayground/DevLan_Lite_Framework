...
/* Idividual Product Restock Limits */
if (isset($_POST['single_restock_limit'])) {
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($users['user_access_level'] != 'Staff') {
            /* Set items restock limits */
            $sql = "UPDATE products SET product_quantity_limit =? WHERE product_id = ?";
            ...
            $prepare->execute();
            if ($prepare) {
                $success = "$product_details Restock Limit Updated";
            } else {
                $err = "Failed!, Please Try Again Later";
            }
        } else {
            $err = "Your Access Level Does Not Allow You To Set Products Restock Limit";
        }
    }
}

/* Batch Restock Limits  */
if (isset($_POST['batch_restock_limits'])) {
    $product_quantity_limit = $_POST['product_quantity_limit'];
    $user_id = $_SESSION['user_id'];
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($users['user_access_level'] != 'Staff') {
            /* Set items restock limits */
            $sql = "UPDATE products SET product_quantity_limit =?";
            $prepare = $mysqli->prepare($sql);
            $bind = $prepare->bind_param(
                's',
                $product_quantity_limit
            ...
            $prepare->execute();
            if ($prepare) {
                $success = "All Products Restock Limits Updated";
            } else {
                $err = "Failed!, Please Try Again Later";
            }
        } else {
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Product Restock Limits</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="">Restock Limits</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <div class="text-right">
                                        <button type="button" data-toggle="modal" data-target="#add_modal" class="btn btn-danger">Batch Restock Limits</button>
                                    </div>
                                    <hr>
                                    <!-- Batch Restock Limits -->
                                        ...
                                        <div class="modal-dialog  modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Set Restock Limit For All Your Products In All Stores</h4>
                                                    ...
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-12">
                                                                <label>New Restock Limit</label>
                                                                <input type="text" name="product_quantity_limit" required class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="text-right">
                                                            <button name="batch_restock_limits" class="btn btn-primary" type="submit">
                                                                Set Limit
                                                            </button>
                                                        </div>
                                                    </form>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Select On Any Product To Update Its Restock Limits</h5>
                                                    </div>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $products->product_quantity_limit; ?></td>
                                                                        <td>
                                                                            <a data-toggle="modal" href="#update_<?php echo $products->product_id; ?>" class="badge badge-primary"><i class="fas fa-edit"></i> Update Restock Limit</a>
                                                                        </td>
                                                                        <!-- Udpate Modal -->
                                                                        <div class="modal fade" id="update_<?php echo $products->product_id; ?>">
                                                                            <div class="modal-dialog  modal-lg">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h4 class="modal-title">Update <?php echo $products->product_code . ' ' . $products->product_name; ?> Restock Limit</h4>
                                                                                        <button type="button" class="close" data-dismiss="modal">
                                                                                            <span>&times;</span>
                                                                                        </button>
                                                                                    </div>
                                                                                    <div class="modal-body">
                                                                                        <div class="text-success text-center">
                                                                                            <h4>Current Restock Limit : <?php echo $products->product_quantity_limit; ?></h4>
                                                                                        </div>
                                                                                        <form method="post" enctype="multipart/form-data">
                                                                                            <div class="form-row">
                                                                                                <div class="form-group col-md-12">
                                                                                            ...
                                                                                            <div class="text-right">
                                                                                                <button name="single_restock_limit" class="btn btn-primary" type="submit">
                                                                                                    Add Limit
                                                                                                </button>
                                                                                            </div>
                                                                                        </form>
