...
if (isset($_POST['add_store'])) {
    ...
    $query = 'INSERT INTO store_settings (store_id,store_name,store_adr,store_email)
    VALUES (?,?,?,?)';
...
if (isset($_POST['delete_store'])) {
    ...
    $store_status  = 'closed';
    $store_name = $_POST['store_name'];
    $store_close_date = date("l jS \of F Y h:i:s A");
                    ...
                    <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Manage Registered Stores</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="main_dashboard_stores">Stores Module</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="pcoded-inner-content">
                            <div class="text-right">
                                <button type="button" data-toggle="modal" data-target="#add_modal" class="btn btn-primary">Register New Store</button>
                            </div>
                            <hr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="text-right">
                                                    <button name="add_store" class="btn btn-primary" type="submit">
                                                        Register Store
                                                    </button>
                                                </div>
                                            </form>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a data-toggle="modal" href="#delete_<?php echo $stores->store_id; ?>" class="badge badge-danger"><i class="fas fa-trash"></i> Close</a>
                                                                        </td>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form method="post" enctype="multipart/form-data">
                                                                                            <div class="form-row">
                                                                                                ...
                                                                                                <div class="form-group col-md-12">
                                                                                                    <label>Store Address</label>
                                                                                                    <textarea type="text" name="store_adr" rows="3" required class="form-control"><?php echo $stores->store_email; ?></textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="text-right">
                                                                        ...
                                                                        <!-- Delete Modal -->
                                                                        <div class="modal fade" id="delete_<?php echo $stores->store_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                    ...
                                                                                    <form method="POST">
                                                                                        <div class="modal-body text-center text-danger">
                                                                                            <h4>
                                                                                                ...
                                                                                                <hr>
                                                                                                This operation is irreversible. Please confirm your password before deleting above store
                                                                                            </h4>
                                                                                            <br>
