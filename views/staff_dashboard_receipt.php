...
/* Show An Alert That Sales Has Been Posted */
if (isset($_GET['msg'])) {
    $success = $msg;
}
?>
...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            <!-- Top Navigation Bar -->
            <?php require_once('../partials/staff_print_receipt_top_bar.php'); ?>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Sale Receipt # <?php echo $_GET['print_receipt']; ?></h5>
                                            <p class="m-b-0">Receipt Preview</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="staff_dashboard_sales?action=empty"> <i class="fa fa-home"></i> </a>
                                            </li>
                                            <li class="breadcrumb-item">
                                                <a href="staff_dashboard_sales?action=empty">Sales</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="">Sale Receipt Preview</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="page-wrapper">
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-block" id="Receipt">
                                                        <!-- Print Receipt -->
                                                        <?php if (isset($_GET['print_receipt']) && isset($_SESSION["cart_item"])) {
                                                            $total_quantity = 0;
                                                            $total_price = 0;
                                                        ?>
                                                            <div class="text-center">
                                                                ...
                                                                $sql = "SELECT * FROM store_settings WHERE store_id = '$user_store_id'";
                                                                ...
                                                                <?php } ?>
                                                                <h6>Cash Sale Receipt # <?php echo $_GET['print_receipt']; ?></h6>
                                                            </div>
                                                ...
                                                <hr>
                                                <div class="text-center">
                                                    <a href="staff_dashboard?action=empty" class="btn btn-primary">
