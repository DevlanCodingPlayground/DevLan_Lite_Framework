...
if (isset($_POST['reset_password'])) {
    ...
    $password_reset_token = $checksum; //Password Reset Keys - Uses Symetrick Key Architecture
    $reset_url  =  $url . $checksum;
    $user_temp_password = "Null";
    // Sql
    $query1 = "UPDATE users SET  user_password_reset_token =? WHERE  user_email =?";
    ...
    $stmt2->execute();
    /* Load Mailer */
    require_once('../mailers/admin_reset_password.php');
    if ($stmt1 && $stmt2 && $mail->send()) {
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            ...
                                            <div class="forgot-phone text-right f-right">
                                                <a href="../" class="text-right f-w-600"> Remember password?</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" name="reset_password" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Reset password</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
