...
/* Excel Column Name */
$fields = array('Product Name', 'Quantity Sold', 'Sold By', 'Sold On', 'Amount (Ksh)');
...
if ($query->num_rows > 0) {
    ...
    while ($row = $query->fetch_assoc()) {
        ...
        $sale_amount = ($row['sale_payment_amount'] - $row['sale_discount']) * $row['sale_quantity'];
        /* Hardwire This Data Into .xls File */
        $lineData = array($row['product_name'], $row['sale_quantity'], $row['user_name'],  $sale_datetime, $sale_amount);
