        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Pet Adopter</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="text-right">
                        <a href="generate_reports?module=Adopters" class="btn btn-primary">Download Records</a>
                                ...
                                <form method="post" enctype="multipart/form-data" role="form">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required name="pet_adopter_email" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="text-right">
                                        <button type="submit" name="Register_Pet_Adopter" class="btn btn-warning">Add Pet Adopter</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $user->pet_adopter_name; ?></td>
                                                    <td><?php echo $user->pet_adopter_email; ?></td>
                                                    <td><?php echo $user->pet_adopter_phone_number; ?></td>
