                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="main_dashboard_sales?action=empty">Sales</a>
                                            </li>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                    ...
                                                    <div class="card-block" id="Receipt">
                                                        ...
                                                        ?>
                                                            <div class="text-center">
                                                                <h4>MASTERPIECE</h4>
                                                                <h4>Electrical & Hardware Supplies</h4>
                                                                <h6>
                                                                    0722 233 600 / 020 - 258 6702 <br>
                                                                    P.O. Box 396-90100, Machakos <br>
                                                                    masterpieceaquaworks@gmail.com <br>
                                                                    VAT: <br>
                                                                    <?php
                                                ...
                                                <hr>
                                                <div class="text-center">
                                                    <a href="main_dashboard_sales?action=empty" class="btn btn-primary">
                                                        <i class="fas fa-cash-register"></i> Return To Sales
                                                    </a>
                                                    <button onclick="printContent('Receipt');" class="btn btn-primary">
