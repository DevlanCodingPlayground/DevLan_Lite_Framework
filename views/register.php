...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            ?>
                <div class="card-body">
                    <p class="login-box-msg">Sign in as a pet owner</p>
                ...
                <!-- /.card-body -->
            <?php
            } else if ($_GET['as'] == 'Adopter') {
            ?>
                <div class="card-body">
                    <p class="login-box-msg">Register pet adopter account</p>
                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" name="Register_Adopter" class="btn btn-primary btn-block">Register</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
