                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Manage Assigned Store</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="manager_dashboard_stores">Stores Module</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-block">
                                                        <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $ret = "SELECT * FROM store_settings WHERE store_status='active' AND store_id=?";
                                                                $stmt = $mysqli->prepare($ret);
                                                                $res =$stmt->bind_param('s',$user_store_id);
                                                                $stmt->execute(); //ok
                                                                $res = $stmt->get_result();
