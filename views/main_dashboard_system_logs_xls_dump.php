...
/* Excel Column Name */
$fields = array('IP Address', 'User Name', 'User Email', 'Date Created',  'Log Details');
...
$query = $mysqli->query("SELECT * FROM system_logs sl
...
if ($query->num_rows > 0) {
    ...
    while ($row = $query->fetch_assoc()) {
        ...
        $lineData = array($row['log_ip_address'], $row['user_name'], $row['user_email'], $log_date, $row['log_details']);
