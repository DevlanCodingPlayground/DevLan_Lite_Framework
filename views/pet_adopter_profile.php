                                    ...
                                    <div class="card-body">
                                        <form method="post" enctype="multipart/form-data" role="form">
                                            ...
                                            <div class="text-right">
                                                <button type="submit" name="update_pet_adopter" class="btn btn-warning">Update Profile</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="card card-warning card-outline">
                                    ...
                                    <div class="card-body">
                                        <form method="post" enctype="multipart/form-data" role="form">
                                            ...
                                            <div class="text-right">
                                                <button type="submit" name="Update_Pet_adopter_Password" class="btn btn-warning">Update Password</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
