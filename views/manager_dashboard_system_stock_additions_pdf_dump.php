    ...
    <html>
        ...
        <body style="margin:1px;">
            ...
            <div class="list_header" align="center">
                ...
                <h5> Stock Addition From '.date('d M Y', strtotime($start)).' To '.date('d M Y', strtotime($end)).' </h5>
            </div>
            ...
            <thead>
                <tr>
                    ...
                    <th style="width:50%">QTY Added</th>
...
$dompdf->render();
$dompdf->stream('Stock Additions Report', array("Attachment" => 1));
