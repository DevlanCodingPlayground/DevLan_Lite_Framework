                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label>Stock Additions From Date</label>
                                                        <input type="date" name="start_date" required class="form-control">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Stock Additions To Date</label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="text-center">
                                                        <a class="btn btn-primary" href="manager_dashboard_system_stock_additions_pdf_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                                        <a class="btn btn-primary" href="manager_dashboard_system_stock_additions_xls_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-spreadsheet"></i> Export To Excel</a>
                                                    </div>
                                                    <br>
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5>Stock Additions Reports</h5>
                                                        </div>
                                                        <div class="card-block">
                                                            <table class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    WHERE i.inventory_date_added  BETWEEN '$start' AND '$end'
                                                                    ORDER BY i.inventory_date_added  DESC ";
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            <td><?php echo $inventory->product_code . ' - ' . $inventory->product_name;  ?></td>
                                                                            <td><?php echo $inventory->inventory_qty_added ?></td>
                                                                            <td><?php echo date('d M Y g:ia', strtotime($inventory->inventory_date_added)) ?></td>
                                                                        </tr>
                                                                    <?php
                                                                    }
                                                                    ?>
