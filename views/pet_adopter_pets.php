            ...
            <section class="content">
                <div class="container-fluid">
                   ...
                   <div class="row">
                        ...
                        WHERE p.pet_adoption_status = 'Available'
                    ...
                    <div class="d-flex justify-content-center">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                ...
                                if ($page >= 2) {
                                    echo "<li class='page-item'><a class='page-link' href='pet_adopter_pets?page=" . ($page - 1) . "'>Previous</a></li>";
                                }

                                for ($i = 1; $i <= $total_pages; $i++) {
                                    if ($i == $page) {
                                        $pagLink .= "<li class='page-item active'><a class = 'active page-link' href='pet_adopter_pets?page=" . $i . "'>" . $i . " </a></li>";
                                    } else {
                                        $pagLink .= "<li class='page-item'><a class='page-link' href='pet_adopter_pets?page=" . $i . "'>" . $i . " </a></li>";
                                    }
                                };
                                echo $pagLink;

                                if ($page < $total_pages) {
                                    echo "<li class='page-item'><a class='page-link'  href='pet_adopter_pets?page=" . ($page + 1) . "'>  Next </a></li>";
                                }
