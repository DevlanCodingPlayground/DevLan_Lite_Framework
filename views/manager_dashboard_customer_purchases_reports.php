                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="text-center">
                                                        <a class="btn btn-primary" href="manager_dashboard_system_customers_pdf_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                                        <a class="btn btn-primary" href="manager_dashboard_system_customers_xls_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-spreadsheet"></i> Export To Excel</a>
                                                    </div>
                                                    <br>
                                                    <div class="card">
