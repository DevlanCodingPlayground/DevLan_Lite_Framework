                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Invetory Report</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="">Invetory Report </a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="">Invetory Report</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="text-center">
                                                    <a class="btn btn-primary" href="main_dashboard_system_inventory_pdf_dump"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                                    <a class="btn btn-primary" href="main_dashboard_system_inventory_xls_dump"><i class="fas fa-file-spreadsheet"></i> Export To Excel</a>
                                                </div>
                                                <br>
                                                <div class="card">
