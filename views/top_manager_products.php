...
if (isset($_POST['update_product'])) {
    ...
    $query = 'UPDATE products SET  product_name =?,product_description =?, product_purchase_price =?, product_sale_price =?,product_quantity =? WHERE product_id =?';
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('ssssss', $product_name, $product_description, $product_purchase_price, $product_sale_price, $product_quantity, $product_id);
    $stmt->execute();
    /* Load Log Helper */
    require_once('../functions/logs.php');
    if ($stmt) {
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea type="text" name="product_description" rows="3" required class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="text-right">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td> <?php echo "Ksh " . number_format($products->product_purchase_price, 2); ?> </td>
                                                                        <td> <?php echo "Ksh " . number_format($products->product_sale_price, 2); ?> </td>
