                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Bulk Import Products</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="main_dashboard_bulk_import_products">Bulk Import </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-block">
                                                        <form method="post" enctype="multipart/form-data">
                                                            <div class="form-group col-md-12">
                                                                <label for="exampleInputFile">Select .XLS With Product Details File. <a class="text-primary" href="../public/system_data/templates/product_template.xlsx">Click Here To Download A Template File</a></label>
