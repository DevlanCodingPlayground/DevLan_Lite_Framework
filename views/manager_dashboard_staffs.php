...
if (isset($_POST['update_user'])) {
    ...
    $query = 'UPDATE users SET user_name =?, user_email =?, user_phoneno =?,user_store_id =? WHERE user_id =?';
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param(
        'ssssss',
        $user_name,
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="manager_dashboard_staffs">Manage USers</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="hidden" name="user_store_id" value="<?php echo $user_store_id; ?>" required class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <table class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                WHERE us.user_status ='active'  && us.user_id != '$user_id' &&  us.user_access_level ='Staff'";
                                                                $stmt = $mysqli->prepare($ret);
                                                                $stmt->execute(); //ok
                                                                $res = $stmt->get_result();
                                                                while ($users = $res->fetch_object()) { ?>
