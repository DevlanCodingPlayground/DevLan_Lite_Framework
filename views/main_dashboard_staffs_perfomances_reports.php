                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Staffs Reports</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="">Staffs Perfomance Reports </a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="">Staffs Perfomance Reports</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <div class="page-body">
                                        <div class="">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="text-right">
                                                    <button name="get_staff_perfomance_reports" class="btn btn-primary" type="submit">
                                                        Get Reports
                                                    </button>
                                                </div>
                                            </form>
                                        ...
                                        <?php
                                        if (isset($_POST['get_staff_perfomance_reports'])) {
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="text-center">
                                                        <a class="btn btn-primary" href="main_dashboard_system_staff_performance_pdf_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                                        <a class="btn btn-primary" href="main_dashboard_system_staff_performance_xls_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-spreadsheet"></i> Export To Excel</a>
                                                    </div>
                                                    <br>
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5>Registered Staff Perfomance</h5>
                                                        </div>
                                                        <div class="card-block">
                                                            <table class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $ret = "SELECT us.user_id, us.user_name,ss.store_name, COUNT(*)AS count,SUM((p.product_sale_price-s.sale_discount)*s.sale_quantity) AS total_cost  FROM sales s 
                                                                   LEFT JOIN products p ON p.product_id =s.sale_product_id
                                                                    INNER JOIN users us ON us.user_id =s.sale_user_id 
                                                                    INNER JOIN store_settings ss ON ss.store_id =us.user_store_id
                                                                   ...
                                                                   GROUP BY us.user_id
                                                                    ...
                                                                    $stmt->execute(); //ok
                                                                    $res = $stmt->get_result();
                                                                    while ($staff_perfomance = $res->fetch_object()) {
                                                                    ?>
                                                                        <tr>
                                                                            <td><?php echo $staff_perfomance->user_name ?></td>
                                                                            <td><?php echo $staff_perfomance->store_name ?></td>
                                                                            <td><?php echo $staff_perfomance->count  ?></td>
                                                                            <td>Ksh <?php echo number_format($staff_perfomance->total_cost, 2) ?></td>
                                                                        </tr>
                                                                    <?php
                                                                    }
                                                                    ?>
