                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <fieldset class="border text-primary border-primary p-2">
                                                    <form method="post" action="main_dashboard_add_to_cart" enctype="multipart/form-data">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-8">
                                                                <label>Select Product</label>
                                                                <select name="cart_product_id" style="width: 100%;" required class="basic form-control">
                                                                    <?php
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="number" value="1" min="1" name="cart_product_qty" required class="form-control">
                                                                <input type="hidden" value="<?php echo $_SESSION['user_store_id']; ?>" name="cart_store_id" required class="form-control">
                                                            </div>
                                                        </div>
