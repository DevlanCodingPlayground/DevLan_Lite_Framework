...
while ($stores = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>Customer Perfomance Report. Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            <div class="list_header" align="center">
                ...
                <h5>Customer Purchases From  ' . $start . ' To ' . $end . ' </h5>
            </div>
            <table border="1" cellspacing="0" width="98%" style="font-size:9pt">
            <thead>
                <tr>
                    <th style="width:100%">Customer Name</th>
                    <th style="width:100%">Customer Phone</th>
                    <th style="width:50%">No of Items</th>
                    <th style="width:100%">Total Expenditure</th>
                </tr>
            </thead>
            ';
        ...
        $html .=
            '
                    <tr>
                        ...
                        <td>Ksh  ' . number_format($customers->total_cost, 2)  . '</td>
                    </tr>
                    ';
    }
    $html .= '
    ...
    $dompdf->render();
    $dompdf->stream('Customer Performance From ' . $start . ' To ' . $end, array("Attachment" => 1));
