...
<body>
    ...
    <h4 class="heading" style="font-size:10pt"><strong>
            ...
            VAT: P051737290V <br>
            Receipt No. '. $_GET["receipt_number"].' <br>
    ...
    <table cellspacing="5"  style="font-size:8.4pt">
        ...
        ';
            ...
            WHERE sale_receipt_no = '$receipt_number'";
            ...
            while ($sales = $res->fetch_object()) {
                /* Amount */
                $discounted_sale_price = $sales->product_sale_price - $sales->sale_discount;
                $html .=
            '
                <tr>
                    ...
                    <td style="text-align:left; overflow-wrap: break-word">
                        <strong>
                            ...
                            ' . $sales->sale_quantity . ' x ' . $discounted_sale_price . '
                        </strong>
                    </td>
                    <td style="text-align:right;"><strong>' . "Ksh " . number_format($discounted_sale_price*$sales->sale_quantity, 2) . '</strong></td>
                </tr>
                    ';
                    $total_quantity += $sales->sale_quantity;
                    $total_price += ($discounted_sale_price* $sales->sale_quantity);
                    $cnt ++;
            }
...
$dompdf->render();
$dompdf->stream('Sale Receipt '.$_GET["receipt_number"], array("Attachment" => 1));
