                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="">System Logs</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="text-center">
                                                        <a class="btn btn-primary" href="main_dashboard_system_logs_pdf_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                                        <a class="btn btn-primary" href="main_dashboard_system_logs_xls_dump?from=<?php echo $_POST['start_date']; ?>&to=<?php echo $_POST['end_date']; ?>"><i class="fas fa-file-spreadsheet"></i> Export To Excel</a>
                                                    </div>
                                                    <br>
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5>System Access Logs</h5>
                                                        </div>
                                                        <div class="card-block">
                                                            <table class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    $ret = "SELECT * FROM system_logs sl
                                                                    INNER JOIN users u ON u.user_id = sl.log_user_id
                                                                    WHERE sl.log_created_at BETWEEN '$start' AND '$end'";
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo $logs->user_email; ?></td>
                                                                            <td><?php echo $logs->log_details; ?></td>
